...
const SplineTablet = ({ onReady }: { onReady?: () => void }) => {
  ...
  const handleLoad = (app: Application) => {
    ...
    // Two rAFs = the scene has actually rendered frames (shaders compiled),
    // so the caller can crossfade to the live canvas without a blank flash.
